package com.pichincha.dm.helper;
...
public class PdfBuilder {
  ...
  public PdfBuilder addBankHeader(String bankName, String documentTitle) {
  ...
  public PdfBuilder addSection(String title) {
    content.append("<div class='section'>");
    content.append("<h3>").append(title).append("</h3>");
    return this;
  }

  public PdfBuilder closeSection() {
    content.append("</div>");
    return this;
  }

  public PdfBuilder addSubsection(String title) {
    content.append("<h4>").append(title).append("</h4>");
    return this;
  }

  public PdfBuilder addInfoTable() {
    content.append("<table class='client-info'>");
    return this;
  }

  public PdfBuilder addDataTable(String... headers) {
  ...
  public PdfBuilder addSummaryTable() {
    content.append("<table class='summary-info'>");
    return this;
  }

  public PdfBuilder addInfoRow(String label, String value) {
    content.append("<tr>");
  ...
  public PdfBuilder addDataRow(String... values) {
    content.append("<tr>");
    if (values != null) {
  ...
  public PdfBuilder addAmountRow(String... values) {
    content.append("<tr>");
    if (values != null) {
  ...
  public PdfBuilder addColoredAmountRow(String label, String amount, boolean isPositive) {
    content.append("<tr>");
    content.append("<td><b>").append(label).append("</b></td>");
  ...
  public PdfBuilder addEmptyMessage(String message) {
